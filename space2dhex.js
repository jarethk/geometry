...
function movePoint(point, dir) {
    return shiftPoint(point, moveSet[dir]);
}
...
export { getAdjacent, getAdjacentInGrid, getSurrounding, getSurroundingInGrid, shiftPoint, shiftPointInGrid, movePoint, printSpace };